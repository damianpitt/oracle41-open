...
- Add threshold-based local alerts for large transfers and approvals.
...
- Add paginated approval-log scans beyond the current 100,000-block window.
- Add explicit completeness metadata to exported activity and token-detail reports.
