...
Python uses the PEP 440 version `0.3.0a2`. Debian package metadata and filenames normalize that pre-release to `0.3.0~a2`, so a later `0.3.0` package is considered a valid upgrade.
