...
Python uses the PEP 440 version `0.4.0a5`. Debian package metadata and filenames normalize that pre-release to `0.4.0~a5`, so a later `0.4.0` package is considered a valid upgrade.
