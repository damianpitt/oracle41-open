...
Oracle41 Open is a Linux-first desktop application. Version `0.4.0a10` is an alpha release, so the distinction between CI validation and broader compatibility targets is important.
