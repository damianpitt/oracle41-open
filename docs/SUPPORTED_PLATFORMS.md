...
Oracle41 Open is a Linux-first desktop application. Version `0.3.0a8` is an alpha release, so the distinction between CI validation and broader compatibility targets is important.
