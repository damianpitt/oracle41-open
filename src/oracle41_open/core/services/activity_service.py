...
class ActivityService:
    ...
    def load_activity(
        ...
        if not force_refresh:
            ...
            if cached is not None:
                ...
                return ActivityPageResult(page=filtered, updated_at=cached.updated_at, is_cached=True)
        ...
        baseline_key = self._baseline_cache_key(normalized_address, chain, normalized_from_block)
        if cursor is None:
            ...
            if baseline is not None:
                ...
                enriched = ActivityPage(items=merged_items, next_cursor=enriched.next_cursor)
    ...
    def _enrich_prices(self, page: ActivityPage, chain: Chain) -> ActivityPage:
        ...
        return ActivityPage(items=deduped, next_cursor=page.next_cursor)
    ...
    def _filter_page(
        ...
        return ActivityPage(items=filtered, next_cursor=page.next_cursor)
